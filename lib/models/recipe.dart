...
List<Recipe> recipes = [
  Recipe(
    ...
    steps: [
      ...
      '3 Masukkan caisim dan taoge. Aduk sampai layu. Tuangkan air rebusan ceker. Aduk rata. Masukkan Bango Kecap Manis. Aduk rata.',
      '4 Bubuhi garam, Royco Kaldu Ayam, merica bubuk dan gula pasir. Aduk rata. Masak sampai matang.',
    ],
  ),
  Recipe(
  ...
  Recipe(
    ...
    steps: [
      '1 Iga bakar: Potong-potong iga sapi hingga menjadi potongan cukup kecil (kira-kira 5-6 cm per potong).',
      '2 Di dalam sebuah wadah, campur Bango Kecap Manis, jeruk nipis, madu dan minyak goreng, aduk rata.',
      '3 Lumuri iga panggang dengan campuran tersebut sampai rata, lalu masukkan ke dalam kulkas, diamkan selama 30 menit.',
      '4 Angkat dan letakkan di pinggan tahan panas. Bakar di oven yang berputar agar matang sempurna dengan suhu 200 derajat selama 30 menit atau sampai matang. Setelah iga matang, sajikan dengan kuah kari.',
      ...
      '7 Masukkan daun jeruk, daun salam dan pala bubuk, aduk rata.',
      '8 Tambahkan garam secukupnya, lalu masukkan sejumput kecil gula pasir (sedikit saja), aduk hingga rata. Biarkan hingga kuah mengental, lalu angkat dan sisihkan.',
    ],
  ),
  Recipe(
    ...
    steps: [
      '1 Tumis bumbu halus dengan daun salam dan lengkuas sampai harum.',
      '2 Masukkan daging, aduk sampai berubah warna.',
      '3 Tuangkan santan sedikit demi sedikit sambil diaduk rata.',
      '4 Tambahkan Bango Kecap Manis, garam, merica putih bubuk, dan gula merah. Aduk rata, masak di atas api kecil sampai matang dan meresap. Sajikan.',
    ],
  ),
  Recipe(
    name:
    ...
    steps: [
      '1 Cuci bersih ketan. Kukus dalam dandang panas selama 15 menit atau hingga setengah matang. Angkat.  ',
      '2 Masak ketan bersama santan, garam, dan daun pandan hingga santan terserap habis. Angkat. Kukus ketan dalam dandang panas hingga matang. Angkat.  ',
      '3 Masukkan ketan kukus ke dalam mangkuk aluminium mini hingga memenuhi 2/3 bagian mangkuk. Tekan-tekan sambil dipadatkan. Sisihkan.  ',
      '4 Srikaya gula merah: Masak santan, air, gula merah, SariWangi Milk Tea Teh Tarik, daun pandan, dan garam di atas api kecil sambil diaduk hingga larut dan harum. Angkat. Biarkan hingga tidak panas. Sisihkan.  ',
      '5 Kocok telur dan gula menggunakan whisk hingga gula larut. Tambahkan tepung terigu, aduk rata. Masukkan larutan gula merah, aduk. Saring.  ',
      '6 Tuang srikaya ke atas ketan. Kukus sebentar atau selama 7-10 menit. Angkat. Biarkan hingga tidak panas. Angkat. Potong-potong. Sajikan.  ',
    ],
  ),
  Recipe(
    name:
    ...
    steps: [
      '1 Ambil daging kambing. Bentuk bola-bola diameter 2 cm. Sisihkan.',
      '2 Rebus santan encer, Kecap Manis Bango, garam, gula, lengkuas, serai, daun kunyit, dan bumbu halus sambil diaduk sampai mendidih.',
      '3 Tambahkan bola bola sambil diaduk sampai empuk dan kuah kental.',
      '4 Tuang santan kental masak dengan api kecil sambil diaduk sampai berminyak.',
    ],
  ),
  Recipe(
    name: 'Mie Koclok',
    ...
    steps: [
      '1 Panaskan minyak dalam wajan, tumis bumbu halus hingga matang dan harum. Tambahkan kaldu ayam (sisakan 50 ml kaldu ayam untuk mengencerkan tepung maizena/sagu). Masak hingga kaldu mendidih, lalu kecilkan api.',
      '2 Encerkan tepung maizena dengan sisa kaldu ayam, lalu tambahkan ke dalam kaldu tadi. Tambahkan juga garam dan merica serta santan kental, terus diaduk-aduk hingga merata dan kaldu agak mengental, kecilkan api.',
      '3 Didihkan air, masukan mie, kol dan taoge kedalam saringan, lalu celupkan ke dalam air mendidih tadi selama kurang lebih satu menit sambil dikocok-kocok hingga sayuran agak layu.',
      '4 Tempatkan semua bahan tadi ke dalam mangkuk/piring, lalu siramkan kuah kental diatasnya.',
      '5 Taburkan suwiran ayam, irisan telur ayam rebus, irisan bawang daun dan seledri diatasnya lalu bawang goreng.',
      '6 Sajikan dengan pendampng sambal cabe rawit, irisan jeruk limo dan Bango Kecap Manis.',
      '7 Membuat sambal rawit: Didihkan air, rebus cabe rawit hingga matang, angkat lalu haluskan. Tempatkan dalam mangkuk kecil dan tambahkan dengan air matang.',
    ],
  ),
  Recipe(
    ...
    steps: [
      '1 Potong pinggiran roti tawar, kemudian pipihkan dengan rolling pin.',
      '2 Tuang 2 scoop Wall’s Strawberry Cheesecake Ice Cream, lalu bentuk menjadi bola dan bungkus dengan plastic wrap. Bekukan dalam freezer.',
      '3 Campurkan telur dan susu, kocok lepas.  ',
      '4 Celupkan bola es krim ke dalam campuran telur, kemudian salut dengan corn flakes yang sudah dihancurkan.',
      '5 Goreng es krim dalam minyak panas di atas api sedang. Setelah keemasan, tiriskan, sajikan.',
    ],
  ),
  Recipe(
    ...
    steps: [
      '1 Adonan dimsum: Aduk rata semua bahan termasuk Royco Kaldu Ayam. Sisihkan.',
      '2 Ambil selembar nori, taruh 1 sdm adonan dimsum ke tengahnya. Lipat dan rekatkan dengan air. Ulangi proses serupa pada sisa bahan.',
      '3 Panaskan dandang, kukus dimsum selama 20 menit atau hingga matang. Angkat. Sisihkan.',
      '4 Saus mentai: Aduk rata semua bahan termasuk Jawara Saus Sambal Extra Hot dan Hellmann’s Real Mayonnaise. Sisihkan.',
      '5 Tata dimsum di atas piring saji atau pinggan tahan panas. Beri masing-masing saus mentai ke atas dimsum. Bakar sebentar bagian atasnya menggunakan blow torch. Sajikan dengan taburan pelengkap.',
    ],
  ),
  Recipe(
    name: 'Sup Jamur',
    ...
    steps: [
      '1 Campur Royco Sup Krim Ayam dengan air dingin, aduk hingga tidak menggumpal.',
      '2 Panaskan margarin, tumis bawang bombay hingga harum.',
      '3 Masukkan bawang putih dan jamur. Tumis hingga jamur matang. Sisihkan 3 sdm jamur.',
      '4 Tuangkan tumis jamur ke dalam sup. Panaskan dengan api sedang. Masukkan garam, merica, pala, dan aduk hingga mengental. Angkat.',
      '5 Haluskan semua bahan dengan blender.',
      '6 Tuangkan ke dalam mangkuk saji. Tambahkan jamur yang tidak diblender. Sajikan.',
    ],
  ),
];