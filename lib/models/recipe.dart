...
List<Recipe> recipes = [
  ...
  Recipe(
    ...
    steps: [
      'Orange jelly: Masak Buavita Orange bersama jelly bubuk di atas api kecil hingga larut dan hampir mendidih. Angkat. Tuang ke dalam wadah tahan panas. Diamkan hingga mengeras.',
      'Parut atau potong kotak orange jelly. Sisihkan.',
      'Aduk Buavita Orange bersama susu cair. Sisihkan.',
      'Siapkan gelas saji yang diisi dengan es batu. Sendokkan orange jelly ke dalamnya. Tuang campuran Buavita Orange. Sajikan.',
    ],
  ),
  Recipe(
